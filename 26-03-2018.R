...
# problem 4
#Лотария се провежда със следните правила. Всеки участник избира
#едно число от 1 до 2n, не е необходимо да избират различни числа. Когато бро-
#  ят на участниците стане n се теглят 5 печеливши числа. Каква е вероятността
